...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val add_buttonClick = findViewById<FloatingActionButton>(R.id.add_note_fab)
        add_buttonClick.setOnClickListener { //view ->
            val intent = Intent(this,add_note::class.java)
            startActivity(intent)

            //test to see if button works (it does)
            //Snackbar.make(add_buttonClick, "Replace with your own action", Snackbar.LENGTH_LONG)
